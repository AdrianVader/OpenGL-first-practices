...
int main(int argc, char *argv[]){  
	...
	cout << "Desea iniciar el modo dificil? La pelota rebotara con su borde en vez de con su centro." << endl;
	do{
		cout << "Elija si o no (s/n)" << endl;
		cin >> hardMode;
	}while(hardMode != 's' && hardMode != 'S' && hardMode != 'n' && hardMode != 'N');
